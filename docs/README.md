...
- 使用技術
  ...
  - open API
- やったこと
  - resume/職務経歴画面の新アーキテクチャへ移行
  - api schema規約の自動化（レビューの自動化）
    - 上記のカスタムルールに対してunit test導入
  - ユビキタス言語の自動チェック、CI組み込み
  - 開発体制の改善、MTG等を改善し生産性を上げる
    - 議論の方法やフォーマットを整備
    - カオスのまま走っていたチームの働き方を再構築(TODO どのような状態をどう直していったかを書く。プロセスはNoteとかに書くと忘れないのでいいかも)  
...
#### キャリトレ事業部（TODO　過去のデータや実績を見ながら追記）
- 期間
  - 2019/06 ~　2022/06
- 担当領域
  - フロントエンド
...
- やったこと
  ...
  - 開発阻害要因の継続的な排除
    - エンジニア外との組織窓口の整備
    - 開発体制の改善
      - チーム内の議論方法や振り返り方法等について継続的に改善をおこない、チーム外にも働きかける（TODO どんな課題を見つけてどのように改善したのか。昔のJIRA等を確認して思い出す。）
    - ドキュメント化
...
## 意欲・興味（TODO　言い方考える）
- 停滞や維持ではなく、変化し続けること、成長し続けることを望んでいます。
...
- チームが未熟なところから出来上がっていくときに発生する課題を解決してきました。ある程度得意分野かと思います。

---

## 希望条件 （TODO　言い方考える。話を聞いてきた中で色々と固まってきたので手直し。）
